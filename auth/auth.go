...
var providers = map[string]providerSpec{
	...
	"meta":                 {envKeys: []string{"META_API_KEY"}},
	"meta-chat":            {envKeys: []string{"META_API_KEY"}},
	"meta-anthropic":       {envKeys: []string{"META_API_KEY"}},
	"moonshotai":           {envKeys: []string{"MOONSHOTAI_API_KEY", "MOONSHOT_API_KEY"}},
	"moonshotai-responses": {envKeys: []string{"MOONSHOTAI_API_KEY", "MOONSHOT_API_KEY"}},
	"moonshotai-anthropic": {envKeys: []string{"MOONSHOTAI_API_KEY", "MOONSHOT_API_KEY"}},
